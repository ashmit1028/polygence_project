...
f = open("/Users/aarasada/champ_ext/data/aime_set_2013_to_2014.txt", "r")

# open output file.
f1 = open("/Users/aarasada/champ_ext/data/gemini/aime_set_2013_to_2014_output.txt", "w")

# open output file to save answers.
f2 = open("/Users/aarasada/champ_ext/data/gemini/aime_set_2013_to_2014_answer.txt", "w")
