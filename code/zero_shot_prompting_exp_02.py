...
f = open("/Users/aarasada/champ_ext/data/aime_large_set_2005_to_2010.txt", "r")

# open output file.
f1 = open("/Users/aarasada/champ_ext/data/chatGPT/aime_large_set_2005_to_2010_output.txt", "w")

# open output file to save answers.
f2 = open("/Users/aarasada/champ_ext/data/chatGPT/aime_large_set_2005_to_2010_answer.txt", "w")
